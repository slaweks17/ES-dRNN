...
DILATIONS=[[2,7],[4]] #moving by 1 day
...
#Will be used, if setting CELL_NAME="LSTM2Cell", at the beginning
...
class DilatedSparseRnnStack(torch.nn.Module):
  ...
  #cellName - either "LSTM", "LSTM2Cell" or "S2Cell"
  def __init__(self, dilations, cellName, input_size, state_size, output_size, h_size=None, inp_size=None):
...
if __name__ == '__main__' or __name__ == 'builtins':
  ...
  rnn=DilatedSparseRnnStack(DILATIONS, CELL_NAME, INPUT_SIZE, STATE_SIZE, TOTAL_OUTPUT_SIZE, H_SIZE, INP_SIZE)
...
# --export
GOOD_RUN="23 embed=4 S2 100,40 [2],[2],[2] [0.49,0.035,0.96] LR=3e-3 {5,/3, 6,/10, 7/30} batch=2 {4:5}"
GOOD_EPOCH=8
